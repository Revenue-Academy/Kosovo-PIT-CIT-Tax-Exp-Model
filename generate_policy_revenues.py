...
def generate_policy_revenues():
    ...
    def calc_gini(df_tax12, tax_type):
        ...
        # df_tax12['All']['weight'] = df_tax12['All']['weight'+'_'+str(start_year)]
        # df_tax12['All']['pre_tax_income'] = df_tax12['All'][income_measure[tax_type]+'_'+str(start_year)]        
        # df_tax12['All']['pitax_current_law'] = df_tax12['All'][tax_collection_var[tax_type]+'_'+str(start_year)]
        # df_tax12['All']['pitax_reform'] = df_tax12['All'][tax_collection_var[tax_type]+'_ref_'+str(start_year)]    
        # gini = pd.DataFrame()
